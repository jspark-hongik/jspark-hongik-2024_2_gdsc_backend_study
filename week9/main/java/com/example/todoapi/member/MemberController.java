...
public class MemberController {
    ...
    public ResponseEntity<Void> updatePassword(@PathVariable("memberId") Long memberId, @RequestBody String newPassword) throws Exception {
        memberService.updatePassword(memberId, newPassword);
        return ResponseEntity.ok().build();
    }

    @PatchMapping("/{memberId}/patch_name")
    public ResponseEntity<Void> updateName(@PathVariable("memberId") Long memberId, @RequestBody String newName) throws Exception {
    ...
    @PostMapping("/logout")
    public ResponseEntity<Void> logout(@RequestBody MemberLogoutRequest request) throws Exception {
