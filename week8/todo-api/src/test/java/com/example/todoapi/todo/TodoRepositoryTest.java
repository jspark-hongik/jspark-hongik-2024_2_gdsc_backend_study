...
public class TodoRepositoryTest {
    ...
    void todoSaveTest() {
        ...
        Todo todo = new Todo("todo content", "2024-12-31", 5, null);
    ...
    void todoFindAllTest() {
        Todo todo1 = new Todo("todo content1", "2024-12-31", 5, null);
        Todo todo2 = new Todo("todo content2", "2024-12-31", 5, null);
        Todo todo3 = new Todo("todo content3", "2024-12-31", 5, null);
    ...
    void todoFindAllByMemberTest() {
        ...
        Todo todo1 = new Todo("todo content", "2024-12-31", 5, member1);
        Todo todo2 = new Todo("todo content", "2024-12-31", 5, member1);
        Todo todo3 = new Todo("todo content", "2024-12-31", 5, member2);
        todoRepository.save(todo1);
        todoRepository.save(todo2);
        todoRepository.save(todo3);
    ...
    void todoUpdateTest() {
        Todo todo1 = new Todo("todo content", "2024-12-31", 5, null);
        todoRepository.save(todo1);
    ...
    void todoDeleteTest() {
        Todo todo1 = new Todo("todo content", "2024-12-31", 5, null);
        Todo todo2 = new Todo("todo content", "2024-12-31", 5, null);
        todoRepository.save(todo1);
        todoRepository.save(todo2);
